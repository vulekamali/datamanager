    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('adjustment_appropriation_professional_fees', models.DecimalField(blank=True, decimal_places=2, max_digits=20, null=True)),
                ('main_appropriation_construction_costs', models.DecimalField(blank=True, decimal_places=2, max_digits=20, null=True)),
                ('adjustment_appropriation_construction_costs', models.DecimalField(blank=True, decimal_places=2, max_digits=20, null=True)),
                ('main_appropriation_total', models.DecimalField(blank=True, decimal_places=2, max_digits=20, null=True)),
                ('adjustment_appropriation_total', models.DecimalField(blank=True, decimal_places=2, max_digits=20, null=True)),
        ...
        migrations.RemoveField(
            model_name='provinfraproject',
            name='contracted_construction_end_date',
        ),
        migrations.RemoveField(
            model_name='provinfraproject',
            name='department',
        ...
        migrations.RemoveField(
            model_name='provinfraproject',
            name='estimated_construction_end_date',
        ),
        migrations.RemoveField(
            model_name='provinfraproject',
        ...
        migrations.AddField(
            ...
            name='project',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='project_snapshots', to='budgetportal.ProvInfraProject'),
        ),
        migrations.AddField(
            model_name='irmsnapshot',
            name='quarter',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='budgetportal.Quarter'),
        ),
    ]
