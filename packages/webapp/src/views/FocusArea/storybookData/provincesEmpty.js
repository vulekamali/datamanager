const provincesEmpty = value => ({
  ...
  provincial: {
    notices: ['This is a notice that is showing because the provinces object is empty'],
    footnotes: [
