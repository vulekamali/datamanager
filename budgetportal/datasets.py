...
class Dataset:
    ...
    def from_package(cls, package):
        ...
        return cls(
            ...
            author={"name": package["author"], "email": package["author_email"]},
            license={
    ...
    def get_resource(self, format, name=None):
        ...
        for resource in self.resources:
            if name and resource["name"] == name and resource["format"] == format:
                return resource
    ...
    def create_resource(self, name, format, url):
        try:
            ...
            logger.info(
                "Upload result: resource '%s' to package %s %r", name, self.slug, result
            )
    ...
    def get_openspending_api(self):
        ...
        api_class_mapping = {
            ...
            "in-year-spending": InYearExpenditure,
        }
...
class Category:
    ...
    def from_group(cls, group):
        return cls(
            slug=group["name"], description=group["description"], name=group["title"]
        )
    ...
    def contributed(cls):
        return cls(
            ...
            slug="contributed",
            description=(
                "Data and analysis contributed by other organisations "
