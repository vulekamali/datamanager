...
from budgetportal.models.gov_structure import GovtFunction, Programme
            ...
            with open("missing_programmes.csv", "w") as missing_programmes_file:
                with open("missing_functions.csv", "w") as missing_functions:
                    ...
                    if not missing_programmes:
                        missing_programmes = csv.DictWriter(
                            missing_programmes_file, reader.fieldnames
                        )
                    ...
                    for row in reader:
                        programmes = Programme.objects.filter(
                            ...
                            department__government__sphere__financial_year__slug=options[
                                "financial_year"
                            ],
                        )
