...
class ProvInfraProject(models.Model):
    ...
    total_professional_fees = models.DecimalField(max_digits=20, decimal_places=10)
    total_construction_costs = models.DecimalField(max_digits=20, decimal_places=10)
    variation_orders = models.DecimalField(max_digits=20, decimal_places=10)
    total_project_cost = models.DecimalField(max_digits=20, decimal_places=10)
    expenditure_from_previous_years_professional_fees = models.DecimalField(max_digits=20, decimal_places=10)
    expenditure_from_previous_years_construction_costs = models.DecimalField(max_digits=20, decimal_places=10)
    expenditure_from_previous_years_total = models.DecimalField(max_digits=20, decimal_places=10)
    project_expenditure_total = models.DecimalField(max_digits=20, decimal_places=10)
    main_appropriation_professional_fees = models.DecimalField(max_digits=20, decimal_places=10)
    adjustment_appropriation_professional_fees = models.DecimalField(max_digits=20, decimal_places=10)
    main_appropriation_construction_costs = models.DecimalField(max_digits=20, decimal_places=10)
    adjustment_appropriation_construction_costs = models.DecimalField(max_digits=20, decimal_places=10)
    main_appropriation_total = models.DecimalField(max_digits=20, decimal_places=10)
    adjustment_appropriation_total = models.DecimalField(max_digits=20, decimal_places=10)
    actual_expenditure_q1 = models.DecimalField(max_digits=20, decimal_places=10)
    actual_expenditure_q2 = models.DecimalField(max_digits=20, decimal_places=10)
    actual_expenditure_q3 = models.DecimalField(max_digits=20, decimal_places=10)
    actual_expenditure_q4 = models.DecimalField(max_digits=20, decimal_places=10)
    ...
    def __str__(self):
        return "{0} ({1})".format(self.name, self.project_number)
